"""
Main fleet analyzer that orchestrates the analysis.
"""
import json
import logging
...
class FleetAnalyzer:
    """Main analyzer for fleet-wide shift analysis."""
    ...
    def analyze_fleet(self, fleet_id: int, start_date: str, end_date: str,
        ...
        if self.analysis_config.parallel_processing:
            self._analyze_vehicles_parallel(
                vehicles, fleet_id, start_date, end_date, output_path
            )
        else:
        ...
        with ThreadPoolExecutor(max_workers=self.analysis_config.max_workers) as executor:
            ...
            future_to_vehicle = {
                executor.submit(
                    ...
                    vehicle, fleet_id, start_date, end_date, output_path
                ): vehicle
    ...
    def _analyze_single_vehicle(self, vehicle: Dict[str, Any], fleet_id: int,
                              start_date: str, end_date: str,
                              output_path: Path) -> Optional[tuple]:
        ...
        try:
            ...
            history_data = self._get_vehicle_history(
                fleet_id, vehicle_id, start_date, end_date
            )
    ...
    def _get_vehicle_history(self, fleet_id: int, vehicle_id: int,
        ...
        try:
            ...
            # Call API with datetime objects
            ...
            return {
                ...
                'fleetId': fleet_id,
                'history': history,
                'startServerTime': start_date,
                'endServerTime': end_date
            }
        except Exception as e:
    ...
    def _save_results(self, fleet_summary: Dict[str, Any], output_path: Path):
        ...
        with open(output_path / 'fleet_analysis.json', 'w') as f:
